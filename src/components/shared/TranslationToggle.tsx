  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1 rounded-full bg-black/40 hover:bg-black/50 shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all duration-300"
      >
