...
//         className="lg:hidden z-100 fixed top-2 left-2 z-60 p-2 bg-white rounded-lg shadow-lg hover:bg-gray-50 transition-colors"
...
const DashboardSidebar = ({ navItems, title = "Florida Yacht Trader", isOpen = false, onClose }: DashboardSidebarProps) => {
  const pathname = usePathname();
  const { logout, user } = useAuth();
