  ...
  return (
    <div className="border border-yellow-200 rounded-lg p-4 bg-yellow-50">
      <p className="text-xs text-yellow-800 font-medium leading-relaxed">
        You don't have promotion credits. You will be charged <strong className="font-bold">{price} AED</strong> directly for the promotion upon publishing this product.
      </p>
    </div>
  );
};
