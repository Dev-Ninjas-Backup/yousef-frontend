...
export function DeleteProductModal({
  ...
  const [deleteProduct, { isLoading: isDeleting }] = useDeleteUserProductMutation();
  const [deleteProductPermanently, { isLoading: isDeletingPermanent }] = useDeleteUserProductPermanentlyMutation();
