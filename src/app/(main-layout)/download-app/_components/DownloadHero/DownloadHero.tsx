    ...
    <section className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, #9BB2D4 0%, #B6D1F9 15%, #D8E5FA 35%, #DBE9FE 55%, #E6F0FF 75%, #E8F1FF 90%, transparent 100%)',
            filter: 'blur(60px)',
          }}
        />
      </div>
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-4">
          ...
          <div className="space-y-6 w-full lg:w-auto">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold">WE ARE</h1>
            ...
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg font-medium flex items-center gap-2">
