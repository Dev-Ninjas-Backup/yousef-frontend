...
import phoneImage1 from "../../../../../assets/home/howItWorks/find_garages.jpg";
...
const stepsData = [
  ...
  },
  {
    ...
    description:
      "Have a question or need an appointment? Message or call the garage directly, no waiting, no hassle. Get instant responses about services, pricing, or availability and make your servicing process faster and smoother.",
    imagePosition: "right" as const,
    phoneImage: phoneImage1,
  },
];
