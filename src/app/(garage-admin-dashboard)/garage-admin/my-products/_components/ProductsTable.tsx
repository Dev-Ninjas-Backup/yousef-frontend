          ...
          <tbody className="divide-y">
            {products.map((product) => (
              <tr key={product.id} className="hover:bg-gray-50">
                ...
                <td className="py-3 px-4 text-sm text-gray-700">{product.views}</td>
                <td className="py-3 px-4 text-sm text-gray-700">{product.inquiries}</td>
                <td className="py-3 px-4">
          ...
          <div key={product.id} className="p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>
                ...
                <span className="ml-1 font-medium text-gray-900">AED {product.price}</span>
              </div>
              <div>
            ...
            <div className="flex items-center gap-2 pt-2">
              <Button variant="outline" size="sm" onClick={() => onView(product.id)} className="flex-1">
                <Eye className="w-4 h-4" />
                View
              </Button>
