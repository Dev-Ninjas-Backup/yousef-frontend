...
import { Phone, Mail, MessageCircle, Clock, FileText, Award, Car, Eye, Edit } from "lucide-react";
...
export function GarageDetailsView({ garage, onEdit }: GarageDetailsViewProps) {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {/* Garage Info */}
      <div className="pt-14">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Premium Auto Care Center</h1>
        ...
        <div className="flex flex-wrap gap-2">
          {services.map((service) => (
            <Badge key={service.id} variant="outline" className="bg-gray-50">
              {service.label}
            </Badge>
          ))}
        </div>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            Premium Auto Care Center offers comprehensive automotive services with over 15 years of experience. 
            We specialize in European and Japanese vehicles, providing quality repairs and maintenance with genuine parts.
          </p>
        </CardContent>
      </Card>
