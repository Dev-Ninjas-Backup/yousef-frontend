  ...
  return (
    <div className="bg-white p-3 sm:p-4 md:p-6 rounded-xl border w-full">
      ...
      <div className="flex flex-col items-center w-full">
        <Card className="border-2 shadow-none w-full border-gray-200 hover:border-blue-600 transition-colors">
          <CardContent className="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
            <div className="flex items-start justify-between gap-3">
              <div>
                <h3 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900">Monthly</h3>
                <p className="text-xs sm:text-sm text-gray-500">Billed every month</p>
              </div>
            ...
            <div className="flex items-baseline gap-1 sm:gap-2">
              ...
              <span className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">100</span>
        ...
        <Button className="w-full text-white bg-blue-600 hover:bg-blue-700 gap-2 mt-4 sm:mt-6 h-10 sm:h-11 md:h-12 text-xs sm:text-sm md:text-base font-medium">
          <CreditCard className="w-4 h-4" />
          <span className="line-clamp-1">Activate Monthly Plan - AED 100</span>
        </Button>
      </div>
    </div>
  );
