        ...
        <CardContent className="p-3 sm:p-4 md:p-6 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-base sm:text-lg md:text-xl">Current Plan</h3>
            </div>
          ...
          <p className="text-xs sm:text-sm">You're on a Free Trial</p>
          ...
          <div className="space-y-2">
            ...
            <Progress value={70} className="bg-blue-800 [&>div]:bg-[#2ECC71] [&>div]:rounded-full h-2" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 pt-2">
            <p className="text-xs sm:text-sm flex flex-col gap-1">
              Trial ends on{" "}
              <span className="font-semibold text-base sm:text-lg md:text-xl">January 1, 2026</span>
            </p>
