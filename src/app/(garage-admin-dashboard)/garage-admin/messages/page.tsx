...
export default function GarageMessagesPage() {
  ...
  console.log("🖥️ [GarageMessagesPage] rendering with:", {
  ...
  return (
    <div className="w-full pt-1 pb-6 mx-auto">
            ...
            <div className="flex-1 overflow-y-auto divide-y divide-gray-50">
              {isConversationsLoading ? (
                ...
                <div className="text-center py-16 px-4">
                  ...
                  <p className="text-xs text-gray-400 mt-1">Conversations with buyers will appear here.</p>
                </div>
              ) : (
